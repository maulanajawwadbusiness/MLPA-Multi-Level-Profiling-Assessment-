...
function createFlowBoxHtml(scale) {
    ...
    <div class="flow-box flow-mode ${scale.expanded ? '' : 'flow-mode-collapsed'}"  
      ...
      <div class="flow-box-tools">
        ...
        <button class="flow-tool-btn export-btn" title="Save as CSV">
          <img src="assets/save_icon.png" alt="Export">
        </button>
        ${!scale.is_root ? `
        <button class="flow-tool-btn delete-btn" title="Delete Scale">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <polyline points="3 6 5 6 21 6"></polyline>
            <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
          </svg>
        </button>` : ''}
        <button class="flow-tool-btn branch-btn" title="Branch to New Version">
...
function createDimensionHtml(dimension, index, startItemIndex, scale) {
    ...
    <div class="dimension-box">
      <div class="dimension-label">
        <span class="dimension-label-line">Dimension ${index}</span>
...
function createRubricPopupHtml(item) {
    ...
    if (!hasRubric) {
      ...
      <div class="rubric-popup">
        <div class="rubric-title">Rubric (placeholder)</div>
        <div class="rubric-list">
          <span class="rubric-item">Will be generated by AI</span>
        </div>
      </div>
    `;
    }
    ...
    return `
    <div class="rubric-popup">
      <div class="rubric-title">Rubric: Basic Traits in Sentence</div>
